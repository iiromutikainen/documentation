...
**NOTICE:** This is not required if you use `setup-node` action in Github Actions. Instead, see https://docs.github.com/en/actions/automating-builds-and-tests/building-and-testing-nodejs#example-using-a-private-registry-and-creating-the-npmrc-file
